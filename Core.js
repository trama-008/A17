...
module.exports = A17 = async (A17, m, chatUpdate, store) => {
  try {
    ...
    const shiroo = [global.shiro].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
Typed *surrender* to surrender and admited defeat`
  ...
  */
    ...
    const responses = {
      ...
      'Sora': `My Boss is lost in another Multiverse, and I lost connection with him...`,
...
*/
      ...
      */
      ...
      case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
        ...
        A17.sendMessage(m.chat, { image: { url: anu }, caption: `Made by SHIRO Bot By SORA...  🪄` }, { quoted: m })
      }
